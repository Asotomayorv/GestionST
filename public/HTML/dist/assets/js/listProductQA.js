...
$(document).ready(function() {
    ...
    table = $('#productQATable').DataTable({
        language: {
        ...
        $('#confirmDeleteButton').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    toastr.success('La boleta de control de calidad eliminada exitosamente.');
                    location.reload(); // Recargar la página 
                },
                error: function(xhr, status, error) {
                    // Manejar errores si es necesario
                    toastr.warning('Ocurrió un error al intentar eliminar la boleta de control de calidad: ' + error);
                }
            });
        });
    });
