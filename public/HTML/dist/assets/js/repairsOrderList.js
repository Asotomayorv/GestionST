        ...
        $('#confirmDeleteButton').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    toastr.success('La boleta de Reparación se eliminó existosamente.');
                    location.reload(); // Recargar la página 
                },
                error: function(xhr, status, error) {
                    // Manejar errores si es necesario
                    toastr.warning('No se puede eliminar la boleta de reparación porque hay reparaciones asociadas');
                }
            });
        });
    });
