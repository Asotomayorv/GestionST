    ...
    <div class="layout-login-centered-boxed__form card">
        <div class="d-flex flex-column justify-content-center align-items-center mt-2 mb-5 navbar-light">
            <a href="index.html" class="navbar-brand flex-column mb-2 align-items-center mr-0" style="min-width: 0">
               <!-- <img class="navbar-brand-icon mr-0 mb-2" src="assets/images/stack-logo-blue.svg" width="25" alt="Stack"> -->
                <span>Gestión Operativa ST</span>
            </a>
            <p class="m-0">Recupera tu Contraseña</p>
        </div>
        <form action="index.html" novalidate>
           ...
           <!-- <div class="form-group mb-5">
            ...
            <div class="form-group text-center">
                <button class="btn btn-primary mb-2" type="submit">Reestablecer Contraseña</button><br>
               <!-- <a class="text-body text-underline" href="login-centered-boxed.html">Have an account? Login</a>-->
            </div>
        </form>
        <div class="page-separator">
            <div class="page-separator__text">ó</div>
        </div>
        <div class="form-group text-center">
            <a href="{{route('user.login')}}">Inicia Sesión</a>
        </div>
    </div>
    <!-- jQuery -->
