...
<div class="card card-form d-flex flex-column flex-sm-row">
    <div class="card-form__body card-body-form-group flex">
        <div class="row">
            ...
            <div class="col-sm-auto">
                <div class="form-group">
                    <a href="" class="btn btn-success" style="margin-top: 25px;">Nuevo Cliente<i class="material-icons">add</i></a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <td>
                            <a href="#" data-toggle="dropdown" data-caret="false" class="text-muted"><i class="material-icons">more_vert</i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="index.html">Ver detalle Cliente</a>
                                    <a class="dropdown-item" href="profile.html">Editar Cliente</a>
                                </div>
                        </td>
                    </div>
                </tr>
